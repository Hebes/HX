...
//        }
//        public static IEnumerator EventTriggerAsync(string eventName)
//        {
//            if (Instance.eventDic.TryGetValue(eventName, out IEvent eventInfo))
//                yield return (eventInfo as EventInfoAsync).TriggerAsync();//如果显示空指针异常,请检查监听的参数和触发的参数是否一致
//        }
...
//        }
//        public static IEnumerator EventTriggerAsync<T>(string eventName, T t)
//        {
//            if (Instance.eventDic.TryGetValue(eventName, out IEvent eventInfo))
//                yield return (eventInfo as EventInfoAsync<T>).TriggerAsync(t);//如果显示空指针异常,请检查监听的参数和触发的参数是否一致
//        }
...
//        }
//        public static IEnumerator EventTriggerAsync<T, K>(string eventName, T t, K k)
//        {
//            if (Instance.eventDic.TryGetValue(eventName, out IEvent eventInfo))
//                yield return (eventInfo as EventInfoAsync<T, K>).TriggerAsync(t, k);//如果显示空指针异常,请检查监听的参数和触发的参数是否一致
//        }
//    }
//}
