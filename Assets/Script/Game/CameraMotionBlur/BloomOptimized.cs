...
public class BloomOptimized : PostEffectsBase
{
    ...
    [Range(0f, 1.5f)] public float threshold = 0.25f;

    [Range(0f, 2.5f)] public float intensity = 0.75f;

    [Range(0.25f, 5.5f)] public float blurSize = 1f;

    private BloomOptimized.Resolution resolution;

    [Range(1f, 4f)] public int blurIterations = 1;
