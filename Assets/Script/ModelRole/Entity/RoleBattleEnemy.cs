...
/// 具体战斗敌人实例
/// </summary>
public class RoleBattleEnemy : IRole, IRoleBehaviour, ISkillCarrier
{
    private uint _id;
    ...
    public RoleBattleEnemy(uint id, string name, ERoleType roleType, ERoleBattlePoint roleBattlePoint, float max_colldown)
    {
        _id = id;
        _name = name;
        _roleType = roleType;
    ...
    uint IID.ID { get => _id; set => _id = value; }
